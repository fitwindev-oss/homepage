...
const koText = {
  ...
  "Full-time": "정규직",
  "Flexible": "협의 가능",
  "Full-time / Flexible": "정규직 / 협의 가능",
  "HEYDAY / FITWIN Platform": "HEYDAY / FITWIN 플랫폼",
  "HEYDAY / FITWIN App": "HEYDAY / FITWIN 앱",
...
const fallbackJobs = [
  {
    id: "heyday-product-engineer",
    title: "Cloud Backend Engineer",
    titleKo: "클라우드 백엔드 개발자",
    department: "HEYDAY / FITWIN Platform",
    location: "Yongin, Korea",
    type: "Full-time / Flexible",
    status: "open",
    summary: "Build the AWS-based backend that connects HEYDAY, FITWIN robots, ANALYSIS, and center operations.",
    summaryKo: "HEYDAY, FITWIN 로봇, ANALYSIS와 센터 운영을 연결하는 AWS 기반 백엔드 시스템을 개발합니다.",
    responsibilities: [
      "Design and operate backend APIs, databases, authentication, and event-driven services on AWS.",
      "Connect member data, robot telemetry, ANALYSIS results, Android apps, and center dashboards into reliable product flows.",
      "Improve deployment, monitoring, testing, security, and cost efficiency across production services.",
    ],
    responsibilitiesKo: [
      "AWS 환경에서 백엔드 API, 데이터베이스, 인증, 이벤트 기반 서비스를 설계하고 운영합니다.",
      "회원 데이터, 로봇 상태 정보, ANALYSIS 결과, Android 앱과 센터 대시보드를 안정적으로 연결합니다.",
      "운영 서비스의 배포, 모니터링, 테스트, 보안, 비용 효율을 지속적으로 개선합니다.",
    ],
    requirements: [
      "Production backend experience with AWS and one or more languages such as TypeScript, Python, Java, or Kotlin.",
      "Hands-on experience with REST APIs, relational or NoSQL databases, cloud deployment, monitoring, and incident debugging.",
      "Ability to use Codex or Claude Code for implementation, refactoring, and tests while independently reviewing correctness, security, and maintainability.",
    ],
    requirementsKo: [
      "AWS와 TypeScript, Python, Java, Kotlin 중 하나 이상을 활용해 운영 환경의 백엔드를 개발한 경험이 있는 분.",
      "REST API, 관계형 또는 NoSQL 데이터베이스, 클라우드 배포, 모니터링, 장애 분석 경험이 있는 분.",
      "Codex 또는 Claude Code를 구현·리팩터링·테스트에 활용하고, 정확성·보안·유지보수성은 직접 검증할 수 있는 분.",
    ],
  },
  {
    id: "android-app-engineer",
    title: "Android App Engineer",
    titleKo: "Android 앱 개발자",
    department: "HEYDAY / FITWIN App",
    location: "Yongin, Korea",
    type: "Full-time / Flexible",
    status: "open",
    summary: "Build Android experiences that connect members and trainers with HEYDAY, FITWIN robots, and ANALYSIS results.",
    summaryKo: "회원과 트레이너가 HEYDAY, FITWIN 로봇, ANALYSIS 결과를 자연스럽게 이용할 수 있는 Android 앱을 개발합니다.",
    responsibilities: [
      "Develop and maintain Android applications with Kotlin and modern Android architecture.",
      "Integrate backend APIs, authentication, notifications, camera, Bluetooth, sensors, and robot or device workflows.",
      "Improve app reliability through testing, performance profiling, release automation, and production monitoring.",
    ],
    responsibilitiesKo: [
      "Kotlin과 현대적인 Android 아키텍처를 기반으로 앱을 개발하고 운영합니다.",
      "백엔드 API, 인증, 알림, 카메라, Bluetooth, 센서, 로봇·디바이스 연동 기능을 구현합니다.",
      "테스트, 성능 분석, 배포 자동화, 운영 모니터링을 통해 앱의 안정성을 높입니다.",
    ],
    requirements: [
      "Android production experience with Kotlin, Jetpack Compose or Android Views, coroutines, and lifecycle-aware architecture.",
      "Experience integrating REST APIs and diagnosing issues across apps, networks, backend services, and physical devices.",
      "Ability to accelerate development with Codex or Claude Code while reviewing generated code and validating behavior on real devices.",
    ],
    requirementsKo: [
      "Kotlin, Jetpack Compose 또는 Android Views, 코루틴, 생명주기 기반 아키텍처로 앱을 운영한 경험이 있는 분.",
      "REST API 연동 경험이 있고 앱, 네트워크, 백엔드, 실제 디바이스를 함께 살피며 문제를 해결할 수 있는 분.",
      "Codex 또는 Claude Code로 개발 속도를 높이되, 생성된 코드를 직접 검토하고 실제 기기에서 동작을 검증할 수 있는 분.",
    ],
  },
  {
    id: "robotics-software-engineer",
    title: "Robotics Software Engineer",
    titleKo: "로봇 소프트웨어 개발자",
    department: "FITWIN MANAGER / MEDIC",
    location: "Yongin, Korea",
    type: "Full-time / Flexible",
    status: "open",
    summary: "Develop the software stack that lets FITWIN robots navigate, perceive, coach, and operate safely in real centers.",
    summaryKo: "FITWIN 로봇이 실제 센터에서 안전하게 이동하고, 인식하고, 코칭하도록 만드는 소프트웨어를 개발합니다.",
    responsibilities: [
      "Develop robotics software for navigation, perception, sensor integration, interaction, and edge-device operation.",
      "Connect face recognition, posture feedback, robot telemetry, and cloud services into one reliable product loop.",
      "Design field tests and safety checks for robots used around real members and trainers.",
    ],
    responsibilitiesKo: [
      "주행, 인식, 센서 연동, 사용자 인터랙션, 엣지 디바이스 운영을 위한 로봇 소프트웨어를 개발합니다.",
      "얼굴 인식, 자세 피드백, 로봇 상태 데이터, 클라우드 서비스를 하나의 안정적인 제품 흐름으로 연결합니다.",
      "실제 회원과 트레이너가 있는 환경에서 로봇이 안전하게 동작하도록 현장 테스트와 안전 기준을 설계합니다.",
    ],
    requirements: [
      "Experience in robotics, control, perception, embedded Linux, ROS/ROS2, or hands-on sensor/device integration.",
      "Ability to debug across cameras, LiDAR, motors, networks, and application software.",
      "Ability to use Codex or Claude Code productively while validating generated changes through simulation, logs, and hardware tests.",
    ],
    requirementsKo: [
      "로보틱스, 제어, 인식, 임베디드 리눅스, ROS/ROS2 또는 센서·디바이스 연동 경험이 있는 분.",
      "카메라, LiDAR, 모터, 네트워크, 애플리케이션 소프트웨어를 넘나들며 문제를 추적할 수 있는 분.",
      "Codex 또는 Claude Code를 실무에 활용하고, 생성된 변경 사항을 시뮬레이션·로그·하드웨어 테스트로 검증할 수 있는 분.",
    ],
  },
  {
    id: "ai-motion-analysis-engineer",
    title: "AI Motion Analysis Engineer",
    titleKo: "AI 동작 분석 개발자",
    department: "FITWIN ANALYSIS",
    location: "Yongin, Korea",
    type: "Full-time / Flexible",
    status: "open",
    summary: "Build the analysis engine that understands movement, physical condition, and exercise disposition from sensor and vision data.",
    summaryKo: "센서와 영상 데이터를 기반으로 회원의 움직임, 신체 상태, 운동 성향을 분석하는 핵심 엔진을 만듭니다.",
    responsibilities: [
      "Build computer-vision, pose-estimation, biomechanics, and signal-processing pipelines for FITWIN ANALYSIS.",
      "Design data collection, labeling, evaluation, and model-quality workflows for movement analysis.",
      "Turn analysis outputs into member reports, coaching metrics, and product-ready insights.",
    ],
    responsibilitiesKo: [
      "FITWIN ANALYSIS를 위한 컴퓨터 비전, 포즈 추정, 생체역학, 신호처리 파이프라인을 구축합니다.",
      "동작 분석을 위한 데이터 수집, 라벨링, 평가, 모델 품질 관리 흐름을 설계합니다.",
      "분석 결과를 회원 리포트, 코칭 지표, 제품에서 바로 활용 가능한 인사이트로 변환합니다.",
    ],
    requirements: [
      "Experience with computer vision, machine learning, signal processing, biomechanics data, or related applied AI work.",
      "Strong Python fundamentals, experiment design, data pipelines, and model evaluation discipline.",
      "Ability to use Codex or Claude Code for experiments and pipeline development while independently validating data quality and model results.",
    ],
    requirementsKo: [
      "컴퓨터 비전, 머신러닝, 신호처리, 생체역학 데이터 또는 응용 AI 개발 경험이 있는 분.",
      "Python 기반 개발, 실험 설계, 데이터 파이프라인, 모델 평가를 탄탄하게 다룰 수 있는 분.",
      "Codex 또는 Claude Code를 실험과 파이프라인 개발에 활용하면서 데이터 품질과 모델 결과를 직접 검증할 수 있는 분.",
    ],
  },
];
